...
public class LogisticRegressionWithSGDDemo 
{
	public static void main(String args[])
	{
		...
		LogisticRegressionWithLBFGS reg = new LogisticRegressionWithLBFGS();
		/*GradientDescent op = reg.optimizer();
		op.setStepSize(Integer.parseInt(args[1]));
		op.setStepSize(Double.parseDouble(args[2]));		
		op.setMiniBatchFraction(1.0);
		op.setUpdater(new SquaredL2Updater());*/
		reg.setNumClasses(2);
